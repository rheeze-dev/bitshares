...
namespace src.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, IdNumber = model.IdNumber, Email = model.Email, FullName = model.FullName };
                var employees = new Employees { Id = user.Id, IdNumber = model.IdNumber, Email = model.Email, FullName = model.FullName };
                var attendance = new Attendance { IdNumber = model.IdNumber, FullName = model.FullName };
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult RegisterSuccessAdmin()
        {
            return View();
        }
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> RegisterAdmin(Guid org, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> RegisterAdmin(Guid org, RegisterViewModel model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
